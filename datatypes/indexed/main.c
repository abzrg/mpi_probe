...
int main(int argc, char** argv)
{
    ...
    int blarray[2] = {3, 3}; // no. of elements of oldtype in each block
    int disparray[2] = {0, 3}; // no. of elements of oldtype difference between
                               // start of each block
    MPI_Type_indexed(count, blarray, disparray, oldtype, &newtype);
