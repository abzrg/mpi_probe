// https://rookiehpc.org/mpi/docs/mpi_iprobe/index.html
...
int main(int argc, char* argv[])
{
    ...
    {
        // The send has not been issued yet, this probe is vain but not
        // blocking.
        int flag;
        ...
        // Inform other MPI process that we issued the MPI_Iprobe meant to be
        // vain
        MPI_Barrier(MPI_COMM_WORLD);
